...
import { useSearchBox } from 'react-instantsearch-nextjs';
...
export default function CuriosityTags() {
    ...
    return (
        <motion.div
            ...
            initial="hidden"
            animate="show"
            className="flex flex-nowrap gap-2 sm:gap-3 justify-center max-w-4xl mx-auto mt-6 overflow-x-auto pb-2"
        >
            {tags.map((tag) => (
                <motion.button
                    key={tag.label}
                    ...
                    className="px-4 py-3 text-base font-medium rounded-full whitespace-nowrap flex-shrink-0
