                ...
                {(opportunity.images && opportunity.images.length > 0) || opportunity.thumbnail ? (
                    ...
                    >
                        <div className="text-center text-neutral-500">
                            ...
                            <p className="text-xs text-neutral-400 mt-1">Click to view details</p>
                        </div>
                    </div>
                )}
                                ...
                                {opportunity.images?.[currentImageIndex]?.startsWith('blob:') ? (
                                    <div className="w-full h-full bg-gradient-to-br from-primary-50 to-primary-100 flex items-center justify-center">
                                        <div className="text-center text-neutral-500">
                                            ...
                                            <p className="text-sm mt-2">This image was uploaded using an older method and is no longer accessible.</p>
                                        </div>
                                    </div>
                                ) : (
                                    <Image
